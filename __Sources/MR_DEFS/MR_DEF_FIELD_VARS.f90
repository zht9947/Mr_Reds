...
!
!   // BELOW ARE DIMENSIONLESS COMBINATIONS
!
!                           NUMFR    :    FLOW FROUDE NUMBER
!                          NUMFRS    :    SHEAR STRESS FROUDE NUMBER
!
! RECORD OF REVISIONS:
!
...
!***********************************************************************************************************************************
  MODULE MR_DEF_FIELD_VARS
    ...
    REAL   (FDRD_KIND) , ALLOCATABLE , DIMENSION(:,:,:    ) :: NUMFR
    REAL   (FDRD_KIND) , ALLOCATABLE , DIMENSION(:,:,:    ) :: NUMFRS
