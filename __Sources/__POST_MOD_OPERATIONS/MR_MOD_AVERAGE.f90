...
!***********************************************************************************************************************************
  MODULE MR_MOD_AVERAGE
    ...
    INTERFACE MR_AVERAGE_UV
      MODULE PROCEDURE MR_AVERAGE_UV_KIND4
      MODULE PROCEDURE MR_AVERAGE_UV_KIND8
    END INTERFACE

    INTERFACE MR_AVERAGE_UV_3D
      MODULE PROCEDURE MR_AVERAGE_UV_3D_KIND4
      MODULE PROCEDURE MR_AVERAGE_UV_3D_KIND8
    END INTERFACE

    INTERFACE MR_AVERAGE_SS
      MODULE PROCEDURE MR_AVERAGE_SS_KIND4
      MODULE PROCEDURE MR_AVERAGE_SS_KIND8
    END INTERFACE

    INTERFACE MR_AVERAGE_SS_3D
      MODULE PROCEDURE MR_AVERAGE_SS_3D_KIND4
      MODULE PROCEDURE MR_AVERAGE_SS_3D_KIND8
    END INTERFACE

    INTERFACE MR_AVERAGE_QUV
      MODULE PROCEDURE MR_AVERAGE_QUV_KIND4
      MODULE PROCEDURE MR_AVERAGE_QUV_KIND8
    END INTERFACE
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_QUV_KIND4( NI , NJ , QUV , QUV_AVERAGE_PLAN , QUV_AVERAGE_XSEC )
    ...
    REAL   (4)         , INTENT(OUT) , DIMENSION(                         1:2) :: QUV_AVERAGE_PLAN
    REAL   (4)         , INTENT(OUT) , DIMENSION(1:NI1(NI,4),             1:2) , OPTIONAL :: QUV_AVERAGE_XSEC
       ...
       !DIR$ VECTOR ALIGNED
        DO I = 1 , NI
          IF( ACTIVITY( I , J ) == BEACTIVE ) THEN
            NUMER_XSEC( I ) = NUMER_XSEC( I ) + SQRT( GUV( I , J ,MOD(DIM,2)+1,MOD(DIM,2)+1) ) *   &
            & QUV( I , J ,DIM) * SQRT( GUV( I , J ,DIM,DIM) )
            DENOR_XSEC( I ) = DENOR_XSEC( I ) + SQRT( GUV( I , J ,MOD(DIM,2)+1,MOD(DIM,2)+1) )
          END IF
        END DO
      END DO
      IF( PRESENT(QUV_AVERAGE_XSEC) ) THEN
       !DIR$ VECTOR ALIGNED
        DO I = 1 , NI
  ...
  END SUBROUTINE MR_AVERAGE_QUV_KIND4
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_QUV_KIND8( NI , NJ , QUV , QUV_AVERAGE_PLAN , QUV_AVERAGE_XSEC )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2) :: QUV
    REAL   (8)         , INTENT(OUT) , DIMENSION(                         1:2) :: QUV_AVERAGE_PLAN
    REAL   (8)         , INTENT(OUT) , DIMENSION(1:NI1(NI,8),             1:2) , OPTIONAL :: QUV_AVERAGE_XSEC
  ...
  END SUBROUTINE MR_AVERAGE_QUV_KIND8
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_UV_KIND4( NI , NJ , UV , UV_AVERAGE_PLAN , UV_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_UV_KIND4
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_UV_KIND8( NI , NJ , UV , UV_AVERAGE_PLAN , UV_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_UV_KIND8
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_UV_3D_KIND4( NI , NJ , NK , H , UV , UV_AVERAGE_PLAN , UV_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_UV_3D_KIND4
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_UV_3D_KIND8( NI , NJ , NK , H , UV , UV_AVERAGE_PLAN , UV_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_UV_3D_KIND8
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_SS_KIND4( NI , NJ , SS , SS_AVERAGE_PLAN , SS_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_SS_KIND4
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_SS_KIND8( NI , NJ , SS , SS_AVERAGE_PLAN , SS_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_SS_KIND8
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_SS_3D_KIND4( NI , NJ , NK , H , SS , SS_AVERAGE_PLAN , SS_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_SS_3D_KIND4
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_AVERAGE_SS_3D_KIND8( NI , NJ , NK , H , SS , SS_AVERAGE_PLAN , SS_AVERAGE_XSEC )
  ...
  END SUBROUTINE MR_AVERAGE_SS_3D_KIND8
