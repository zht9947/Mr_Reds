...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_EQK_SRC_XY( NI , NJ , K , EQKD_PRO_K , EQKD_GRO_K , EQK_SRC_XY )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ) :: EQKD_PRO_K , EQKD_GRO_K
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ) :: EQK_SRC_XY
