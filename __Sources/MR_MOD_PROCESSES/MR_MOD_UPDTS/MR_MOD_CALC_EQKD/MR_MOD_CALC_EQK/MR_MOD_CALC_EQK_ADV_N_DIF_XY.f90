...
!***********************************************************************************************************************************
  ...
  ! REVISE ADVECTION BY THE DEPTH H
    CALL MR_COPY_SS( EQK_QADV_XY_U , EQK_QADV_XY_U .MRSSMTP. HU )
    CALL MR_COPY_SS( EQK_QADV_XY_V , EQK_QADV_XY_V .MRSSMTP. HV )
    CALL MR_CALC_REDC_GRAD_XY_SS( NI , NJ , EQK_QADV_XY_U , EQK_QADV_XY_V , EQK_ADV_XY )
  ! CONTRAVARIANTLY TRANSFORM
    CALL MR_COPY_SS( EQK_ADV_XY , EQK_ADV_XY .MRSSDIV. H )

  ! CALCULATE DIFFUSION
  ! REVISE DIFFUSION BY THE DEPTH H
    CALL MR_COPY_SS( EQK_QDIF_XY_U , EQK_QDIF_XY_U .MRSSMTP. HU )
    CALL MR_COPY_SS( EQK_QDIF_XY_V , EQK_QDIF_XY_V .MRSSMTP. HV )
    CALL MR_CALC_REDC_GRAD_XY_SS( NI , NJ , EQK_QDIF_XY_U , EQK_QDIF_XY_V , EQK_DIF_XY )
  ! CONTRAVARIANTLY TRANSFORM
    CALL MR_COPY_SS( EQK_DIF_XY , EQK_DIF_XY .MRSSDIV. H )
