...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_EQK_A3_B3_C3( NI , NJ , NK , EQK_A3 , EQK_B3 , EQK_C3 )
    ...
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(CARD_KIND),1:NJ,2:NK  ) :: EQK_A3
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(CARD_KIND),1:NJ,1:NK  ) :: EQK_B3
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(CARD_KIND),1:NJ,1:NK-1) :: EQK_C3
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_EQK_D3( NI , NJ , NK , EQKD_PRO , EQKD_GRO , EQK_D3 )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(FDRD_KIND),1:NJ,1:NK  ) :: EQKD_PRO , EQKD_GRO

    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(CARD_KIND),1:NJ,1:NK  ) :: EQK_D3

    REAL   (FDRD_KIND) , DIMENSION(1:NI1(FDRD_KIND),1:NJ,1:NK) :: EQK_ADV_Z  , EQK_DIF_Z
    REAL   (FDRD_KIND) , DIMENSION(1:NI1(FDRD_KIND),1:NJ     ) :: EQK_ADV_XY , EQK_DIF_XY , EQK_SRC_XY
