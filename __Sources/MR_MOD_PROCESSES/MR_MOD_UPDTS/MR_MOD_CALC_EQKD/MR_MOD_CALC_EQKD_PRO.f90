...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_EQKD_PRO( NI , NJ , NK , EQKD_PRO )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,    1:NK) :: EQKD_PRO

    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,    0:NK) :: EQKD_PRO_W
    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2,0:NK) :: TUV_W
    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ         ) :: TUV_SQR_W

    INTEGER(IJID_KIND) :: I , J
    INTEGER            :: DIM
    INTEGER(KKID_KIND) :: K

    ALLOCATE( TSUV(1:NI1(NI,FDRD_KIND),1:NJ,1:2) ) ; TSUV(1:NI,1:NJ,1:2) = 0.0
