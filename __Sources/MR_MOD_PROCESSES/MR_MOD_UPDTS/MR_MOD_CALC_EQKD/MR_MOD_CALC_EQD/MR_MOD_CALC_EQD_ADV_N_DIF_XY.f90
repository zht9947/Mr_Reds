...
!***********************************************************************************************************************************
  ...
  ! REVISE ADVECTION BY THE DEPTH H
    CALL MR_COPY_SS( EQD_QADV_XY_U , EQD_QADV_XY_U .MRSSMTP. HU )
    CALL MR_COPY_SS( EQD_QADV_XY_V , EQD_QADV_XY_V .MRSSMTP. HV )
    CALL MR_CALC_REDC_GRAD_XY_SS( NI , NJ , EQD_QADV_XY_U , EQD_QADV_XY_V , EQD_ADV_XY )
  ! CONTRAVARIANTLY TRANSFORM
    CALL MR_COPY_SS( EQD_ADV_XY , EQD_ADV_XY .MRSSDIV. H )

  ! CALCULATE DIFFUSION
  ! REVISE DIFFUSION BY THE DEPTH H
    CALL MR_COPY_SS( EQD_QDIF_XY_U , EQD_QDIF_XY_U .MRSSMTP. HU )
    CALL MR_COPY_SS( EQD_QDIF_XY_V , EQD_QDIF_XY_V .MRSSMTP. HV )
    CALL MR_CALC_REDC_GRAD_XY_SS( NI , NJ , EQD_QDIF_XY_U , EQD_QDIF_XY_V , EQD_DIF_XY )
  ! CONTRAVARIANTLY TRANSFORM
    CALL MR_COPY_SS( EQD_DIF_XY , EQD_DIF_XY .MRSSDIV. H )
