...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_HYD_A3_B3_C3( NI , NJ , NK , HYD_A3 , HYD_B3 , HYD_C3 )
    ...
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,    2:NK  ) :: HYD_A3
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,    1:NK  ) :: HYD_B3
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,    1:NK-1) :: HYD_C3
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_RAW_HYD_D3( NI , NJ , NK , HYD_D3 )
    ...
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,1:2,1:NK  ) :: HYD_D3

    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2,1:NK) :: HYD_ADV_Z  , HYD_DIF_Z
    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2     ) :: HYD_ADV_XY , HYD_DIF_XY , HYD_BAR_XY , HYD_COR_XY
