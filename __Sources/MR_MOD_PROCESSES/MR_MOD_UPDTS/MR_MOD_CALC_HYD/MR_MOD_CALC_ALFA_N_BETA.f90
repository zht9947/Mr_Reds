...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_ALFA_N_BETA( NI , NJ , NK , HYD_D3 , ALFA , BETA )
    ...
    REAL   (CARD_KIND) , INTENT(INOUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,1:2,1:NK) :: HYD_D3

    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND),1:NJ,1:2) :: ALFA , BETA
  ...
  ! REVISE HYD_D3
    ...
    CALL MR_COPY_UV( BETA , BETA .MRUVMTP. H )
