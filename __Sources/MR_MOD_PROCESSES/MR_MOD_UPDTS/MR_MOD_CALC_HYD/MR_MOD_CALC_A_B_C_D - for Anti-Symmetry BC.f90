...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_A1_B1_C1( NI , NJ , ALFA , A1 , B1 , C1 )
    ...
    REAL   (CARD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ  ,1:2) :: ALFA

    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(2:NI2(NI,CARD_KIND)  ,1:NJ      ) :: A1
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ      ) :: B1
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI2(NI,CARD_KIND)-1,1:NJ      ) :: C1
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_D1( NI , NJ , ZS , ALFA , BETA , D1 )
    ...
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ      ) :: D1
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_A2_B2_C2( NI , NJ , ALFA , A2 , B2 , C2 )
    ...
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,2:NJ      ) :: A2
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ      ) :: B2
    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ-1    ) :: C2
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_D2( NI , NJ , ZT , BETA , D2 )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,FDRD_KIND)  ,1:NJ      ) :: ZT
    REAL   (CARD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ  ,1:2) :: BETA

    REAL   (CARD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,CARD_KIND)  ,1:NJ      ) :: D2
