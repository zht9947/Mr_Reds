...
!
!***********************************************************************************************************************************
  MODULE MR_MOD_GEN_WRITE_FIELD_VARS_N_ACTIVITY
    ...
    PUBLIC :: MR_GEN_WRITE_UV
    PUBLIC :: MR_GEN_WRITE_SS
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_GEN_WRITE_ACTIVITY( DSET_ACTIVITY_ID , NEM , NI , NJ , EMIDW , ACTIVITY , ERROR , ERRMSG )
...
!***********************************************************************************************************************************
  ...
  END SUBROUTINE MR_GEN_WRITE_ACTIVITY
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_GEN_WRITE_UV( MULTI_DSETS_ID , PATH_UV_IN_MULTI_DSETS , T ,   &
    ...
    ELSE
      ...
      ELSE
        ...
        IF( PRESENT( ACTIVITY ) ) THEN
          CALL MR_GEN_WRITE_ACTIVITY( DSET_UV_ID , NEM , NI , NJ , EMIDW , ACTIVITY , ERROR , ERRMSG )
          IF( ERROR < 0 ) THEN
...
!***********************************************************************************************************************************
  ...
  END SUBROUTINE MR_GEN_WRITE_UV
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_GEN_WRITE_SS( MULTI_DSETS_ID , PATH_SS_IN_MULTI_DSETS , T ,   &
   ...
   !END$ FORCEINLINE
    ...
    ELSE
      ...
      ELSE
        ...
        IF( PRESENT( ACTIVITY ) ) THEN
          CALL MR_GEN_WRITE_ACTIVITY( DSET_SS_ID , NEM , NI , NJ , EMIDW , ACTIVITY , ERROR , ERRMSG )
          IF( ERROR < 0 ) THEN
...
!***********************************************************************************************************************************
  ...
  END SUBROUTINE MR_GEN_WRITE_SS

  END MODULE MR_MOD_GEN_WRITE_FIELD_VARS_N_ACTIVITY