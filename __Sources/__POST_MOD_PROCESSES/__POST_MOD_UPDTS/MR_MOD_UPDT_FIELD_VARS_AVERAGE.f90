...
!***********************************************************************************************************************************
  ...
  ! UPDATE AVERAGE_UNIT_ENERGY
    CALL MR_AVERAGE_SS_BY_AREA( NI , NJ , UNIT_ENERGY(:,:,1) , AVERAGE_PLAN_UNIT_ENERGY ,   &
    & AVERAGE_XSEC_UNIT_ENERGY )
  ! UPDATE AVERAGE_UNIT_CIRC_INTENSITY
    CALL MR_AVERAGE_SS_BY_LINE( NI , NJ , UNIT_ENERGY(:,:,1) , AVERAGE_PLAN_UNIT_CIRC_INTENSITY(1) ,   &
    & AVERAGE_XSEC_UNIT_CIRC_INTENSITY(:,1) )
    CALL MR_AVERAGE_SS_BY_LINE( NI , NJ , UNIT_ENERGY(:,:,2) , AVERAGE_PLAN_UNIT_CIRC_INTENSITY(2) ,   &
    & AVERAGE_XSEC_UNIT_CIRC_INTENSITY(:,2) )
  ...
  ! UPDATE AVERAGE_TBUV
    ...
    CALL MR_COPY_UV( QUV , UVA .MRUVMTP. H )
  ! UPDATE AVERAGE_QUV
