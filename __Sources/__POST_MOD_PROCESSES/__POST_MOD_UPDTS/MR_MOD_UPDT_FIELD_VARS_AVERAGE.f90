...
!***********************************************************************************************************************************
  ...
  ! UPDATE AVERAGE_UNIT_FORCES AND AVERAGE_UNIT_MOTION
    ...
    CALL MR_AVERAGE_UV( NI , NJ , UNIT_FORCES , AVERAGE_PLAN_UNIT_FORCES , AVERAGE_XSEC_UNIT_FORCES  )
    CALL MR_AVERAGE_UV( NI , NJ , UNIT_MOTION , AVERAGE_PLAN_UNIT_MOTION , AVERAGE_XSEC_UNIT_MOTION )
    DEALLOCATE( UNIT_FORCES , UNIT_MOTION )

  ! UPDATE AVERAGE_UNIT_ENERGY
    ALLOCATE( UNIT_ENERGY(1:NI1(NI,FDRD_KIND),1:NJ,1:NK) )
    CALL MR_CALC_UNIT_ENERGY( NI , NJ , NK , UNIT_ENERGY )
    CALL MR_AVERAGE_SS_3D( NI , NJ , NK , H , UNIT_ENERGY , AVERAGE_PLAN_UNIT_ENERGY , AVERAGE_XSEC_UNIT_ENERGY )
    DEALLOCATE( UNIT_ENERGY )

  ! UPDATE AVERAGE_TBFUV
    CALL MR_AVERAGE_UV( NI , NJ , TBFUV , AVERAGE_PLAN_TBFUV , AVERAGE_XSEC_TBFUV )
    CALL MR_AVERAGE_SS( NI , NJ ,   &
  ...
  ! UPDATE AVERAGE_QUV
    ...
    QUV = UVA .MRUVMTP. H
    CALL MR_AVERAGE_QUV(NI , NJ , QUV , AVERAGE_PLAN_QUV , AVERAGE_XSEC_QUV )
    DEALLOCATE( QUV )
