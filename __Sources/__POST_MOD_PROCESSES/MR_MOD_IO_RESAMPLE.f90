...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_IO_RESAMPLE( FILE_XMDF_NAME , FILE_XMDF_NAME_ , ITS , T , ERROR , ERRMSG )
  ...
  ! OPEN TARGET
   ...
   !END BLOCK
    ...
    CALL MR_RW_RESAMPLE_UV( MULTI_DSETS_ID , MULTI_DSETS_ID_ , ITS , T , NI , NJ , ERROR , ERRMSG )
    IF( ERROR < 0 ) THEN
    ...
    CALL MR_RW_RESAMPLE_SS( MULTI_DSETS_ID , MULTI_DSETS_ID_ , ITS , T , NI , NJ , ERROR , ERRMSG )
    IF( ERROR < 0 ) THEN
      ERRMSG = TRIM(ERRMSG)//" "//TRIM(FILE_XMDF_NAME)//" and "//TRIM(FILE_XMDF_NAME_)
      CALL MR_CLOSE_MULTI_DSETS( MULTI_DSETS_ID , ERROR_DUMMY , ERRMSG_DUMMY )
      CALL MR_CLOSE_MULTI_DSETS( MULTI_DSETS_ID_ , ERROR_DUMMY , ERRMSG_DUMMY )
  ...
  END SUBROUTINE MR_IO_RESAMPLE

  END MODULE MR_MOD_IO_RESAMPLE