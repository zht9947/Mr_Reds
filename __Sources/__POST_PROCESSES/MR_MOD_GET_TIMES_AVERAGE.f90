...
!***********************************************************************************************************************************
  MODULE MR_MOD_GET_TIMES_AVERAGE
    ...
    PUBLIC :: MR_GET_T_ITS_AVERAGE , MR_GET_T_NTSS_AVERAGE
...
!***********************************************************************************************************************************
  ...
  ! GET NTSS FROM ZB
    ...
    CALL MR_GET_NTSS( MULTI_DSETS_ID , PATH_DSET_IN_MULTI_DSETS , NTSS , ERROR , ERRMSG )
    IF( ERROR < 0 ) THEN
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_GET_T_ITS_AVERAGE( FILE_XMDF_NAME , ITS , T_ITS , ERROR , ERRMSG )
  ...
  ! GET T OF ITS FROM ZB
    PATH_DSET_IN_MULTI_DSETS = "Mr.Reds/"//DSET_NAME_ZB
    CALL MR_GET_T_ITS( MULTI_DSETS_ID , PATH_DSET_IN_MULTI_DSETS , ITS , T_ITS , ERROR , ERRMSG )
    IF( ERROR < 0 ) THEN
      CALL MR_CLOSE_MULTI_DSETS( MULTI_DSETS_ID , ERROR_DUMMY , ERRMSG_DUMMY )
      CALL MR_CLOSE_FILE_XMDF( FILE_XMDF_ID , ERROR_DUMMY , ERRMSG_DUMMY )
      RETURN
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_GET_T_NTSS_AVERAGE( FILE_XMDF_NAME , T_NTSS , ERROR , ERRMSG )
  ...
  ! GET T OF NTSS FROM ZB
    PATH_DSET_IN_MULTI_DSETS = "Mr.Reds/"//DSET_NAME_ZB
    CALL MR_GET_T_NTSS( MULTI_DSETS_ID , PATH_DSET_IN_MULTI_DSETS , T_NTSS , ERROR , ERRMSG )
    IF( ERROR < 0 ) THEN
      CALL MR_CLOSE_MULTI_DSETS( MULTI_DSETS_ID , ERROR_DUMMY , ERRMSG_DUMMY )
      CALL MR_CLOSE_FILE_XMDF( FILE_XMDF_ID , ERROR_DUMMY , ERRMSG_DUMMY )
      RETURN
  ...
  END SUBROUTINE MR_GET_T_NTSS_AVERAGE
