...
!
!***********************************************************************************************************************************
  MODULE MR_MOD_MALLOC_FIELD_VARS_RESAMPLE
    ...
    PUBLIC :: MR_MALLOC_FIELD_VARS_RESAMPLE
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_MALLOC_FIELD_VARS_RESAMPLE
  ...
  END SUBROUTINE MR_MALLOC_FIELD_VARS_RESAMPLE

  END MODULE MR_MOD_MALLOC_FIELD_VARS_RESAMPLE