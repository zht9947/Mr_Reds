...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_GRAD_XY_UV( NI , NJ , UU , VV , GRAD_XY_UV )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2,1:2) :: GRAD_XY_UV
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_REDC_GRAD_XY_UV( NI , NJ , UU , VV , REDC_GRAD_XY_UV )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2) :: REDC_GRAD_XY_UV

    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2,1:2) :: GRAD_XY_UV
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_GRAD_XY_SS( NI , NJ , SU , SV , GRAD_XY_SS )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2) :: GRAD_XY_SS
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_REDC_GRAD_XY_SS( NI , NJ , SU , SV , REDC_GRAD_XY_SS )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ) :: REDC_GRAD_XY_SS

    REAL   (FDRD_KIND) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2) :: GRAD_XY_SS
