...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_GRAD_Z_UV( NI , NJ , NK , UVW , GRAD_Z_UV )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:2,1:NK) :: GRAD_Z_UV
...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_GRAD_Z_SS( NI , NJ , NK , SW , GRAD_Z_SS )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),1:NJ,1:NK) :: GRAD_Z_SS
