...
!***********************************************************************************************************************************
  MODULE MR_MOD_CALC_QADV_N_QDIF_XY
    ...
    PUBLIC :: MR_CALC_QADV_N_QDIF_XY_UV_U , MR_CALC_T_XY_UV_U
    PUBLIC :: MR_CALC_QADV_N_QDIF_XY_SS_U , MR_CALC_T_XY_SS_U

    PUBLIC :: MR_CALC_QADV_N_QDIF_XY_UV_V , MR_CALC_T_XY_UV_V
    PUBLIC :: MR_CALC_QADV_N_QDIF_XY_SS_V , MR_CALC_T_XY_SS_V
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U( NI , NJ , UV , VV , RB , U , EKXY , VXYU , T_XY_UV_U )
    ...
    REAL   (PARD_KIND) , INTENT(IN ) :: RB , EKXY
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(0:NI0(NI,FDRD_KIND),1:NJ    ) :: U , VXYU
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI0(NI,FDRD_KIND),1:NJ,1:2) :: T_XY_UV_U
    ...
    DO DIM = 1 , 2
      ...
      DO J = 1 , NJ
        ...
        I = 0
         !DIR$ FORCEINLINE
          CALL MR_CALC_T_XY_UV_U_I0_JJ
        !END I = 0

        I = 1
         !DIR$ FORCEINLINE
          CALL MR_CALC_T_XY_UV_U_I1_JJ
        !END I = 1

       !DIR$ VECTOR ALIGNED
        DO I = 2 , NI-2
         !DIR$ FORCEINLINE
          CALL MR_CALC_T_XY_UV_U_II_JJ
        END DO

        I = NI-1
         !DIR$ FORCEINLINE
          CALL MR_CALC_T_XY_UV_U_IM_JJ
        !END I = NI-1

        I = NI
         !DIR$ FORCEINLINE
          CALL MR_CALC_T_XY_UV_U_IN_JJ
        !END I = NI
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U_I0_JJ
  ...
  ! AT FREE INTERNAL INTERFACE
    ...
    ! CALCULATE T-SHEAR
      T_XY_UV_U( I , J ,DIM) = EKXY * VXYU( I , J ) *   &
      ( FUU( I , J ,1,1) *   &
        (                       DDU                                                       &
        -         CRU         * D2U                                               / 2.0   &
        )   &
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_U_I0_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U_I1_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_U_I1_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U_II_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_U_II_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U_IM_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_U_IM_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_U_IN_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_U_IN_JJ

  END SUBROUTINE MR_CALC_T_XY_UV_U
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U( NI , NJ , SS , SV , RB , U , SCXY , DXYU , T_XY_SS_U )
    ...
    REAL   (PARD_KIND) , INTENT(IN ) :: RB , SCXY
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(0:NI0(NI,FDRD_KIND),1:NJ) :: U , DXYU
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI0(NI,FDRD_KIND),1:NJ) :: T_XY_SS_U
    ...
    DO J = 1 , NJ
      ...
      I = 0
       !DIR$ FORCEINLINE
        CALL MR_CALC_T_XY_SS_U_I0_JJ
      !END I = 0

      I = 1
       !DIR$ FORCEINLINE
        CALL MR_CALC_T_XY_SS_U_I1_JJ
      !END I = 1

     !DIR$ VECTOR ALIGNED
      DO I = 2 , NI-2
       !DIR$ FORCEINLINE
        CALL MR_CALC_T_XY_SS_U_II_JJ
      END DO

      I = NI-1
       !DIR$ FORCEINLINE
        CALL MR_CALC_T_XY_SS_U_IM_JJ
      !END I = NI-1

      I = NI
       !DIR$ FORCEINLINE
        CALL MR_CALC_T_XY_SS_U_IN_JJ
      !END I = NI
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U_I0_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_U_I0_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U_I1_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_U_I1_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U_II_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_U_II_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U_IM_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_U_IM_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_U_IN_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_U_IN_JJ

  END SUBROUTINE MR_CALC_T_XY_SS_U
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V( NI , NJ , UV , UU , RB , V , EKXY , VXYV , T_XY_UV_V )
    ...
    REAL   (PARD_KIND) , INTENT(IN ) :: RB , EKXY
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,FDRD_KIND),0:NJ    ) :: V , VXYV
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),0:NJ,1:2) :: T_XY_UV_V
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V_II_J0

    IMPLICIT NONE

    T_XY_UV_V( I , J ,DIM) = 0.0

  END SUBROUTINE MR_CALC_T_XY_UV_V_II_J0
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V_II_J1
  ...
  ! AT FREE INTERNAL INTERFACE
    ...
    ! CALCULATE T-SHEAR
      T_XY_UV_V( I , J ,DIM) = EKXY * VXYV( I , J ) *   &
      ( FVV( I , J ,2,2) *   &
        (                       DDV                           &
        -         CRV         * D2V                   / 2.0   &
        )   &
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_V_II_J1
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V_II_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_V_II_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V_II_JM
  ...
  END SUBROUTINE MR_CALC_T_XY_UV_V_II_JM
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_UV_V_II_JN

    IMPLICIT NONE

    T_XY_UV_V( I , J ,DIM) = 0.0

  END SUBROUTINE MR_CALC_T_XY_UV_V_II_JN

  END SUBROUTINE MR_CALC_T_XY_UV_V
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V( NI , NJ , SS , SU , RB , V , SCXY , DXYV , T_XY_SS_V )
    ...
    REAL   (PARD_KIND) , INTENT(IN ) :: RB , SCXY
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI1(NI,FDRD_KIND),0:NJ) :: V , DXYV
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(NI,FDRD_KIND),0:NJ) :: T_XY_SS_V
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V_II_J0

    IMPLICIT NONE

    T_XY_SS_V( I , J ) = 0.0

  END SUBROUTINE MR_CALC_T_XY_SS_V_II_J0
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V_II_J1
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_V_II_J1
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V_II_JJ
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_V_II_JJ
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V_II_JM
  ...
  END SUBROUTINE MR_CALC_T_XY_SS_V_II_JM
...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_T_XY_SS_V_II_JN

    IMPLICIT NONE

    T_XY_SS_V( I , J ) = 0.0

  END SUBROUTINE MR_CALC_T_XY_SS_V_II_JN

  END SUBROUTINE MR_CALC_T_XY_SS_V
