...
!***********************************************************************************************************************************
  ...
  ! AND SET OUTPUT FILES' PATH\NAMES
    ...
    IF( ERROR < 0 ) THEN
      ...
      WRITE(*,'(  "          In this case, resampling will be started from the timestep specified")')
      ...
      WRITE(*,'(  "        <by> is the increment of timestep by which the resampling will be done;")')
      WRITE(*,'(  "          In this case, resampling will be started from the timestep specified")')
      WRITE(*,'(  "        by <from> and ended to the timestep specified by <to> with an increment")')
      WRITE(*,'(  "        of timestep specified by <by>;")')
      WRITE(*,'(  "      If omitted when command argument no.2 is specified as case A, the increment")')
      WRITE(*,'(  "    of timestep will be set to 1 by default;")')
