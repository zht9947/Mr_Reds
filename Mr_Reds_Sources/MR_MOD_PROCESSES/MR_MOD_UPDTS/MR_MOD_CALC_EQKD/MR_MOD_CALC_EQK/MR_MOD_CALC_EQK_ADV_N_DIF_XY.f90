...
!***********************************************************************************************************************************
  SUBROUTINE MR_CALC_EQK_ADV_N_DIF_XY( NI , NJ , K , EQK_ADV_XY , EQK_DIF_XY )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI1(FDRD_KIND),1:NJ) :: EQK_ADV_XY , EQK_DIF_XY

    REAL   (FDRD_KIND) , DIMENSION(0:NI0(FDRD_KIND),1:NJ) :: EQK_QADV_XY_U , EQK_QDIF_XY_U
    REAL   (FDRD_KIND) , DIMENSION(1:NI1(FDRD_KIND),0:NJ) :: EQK_QADV_XY_V , EQK_QDIF_XY_V

    ALLOCATE( KIV(1:NI1(FDRD_KIND),0:NJ) )
    ...
    ALLOCATE( KIU(0:NI0(FDRD_KIND),1:NJ) )
