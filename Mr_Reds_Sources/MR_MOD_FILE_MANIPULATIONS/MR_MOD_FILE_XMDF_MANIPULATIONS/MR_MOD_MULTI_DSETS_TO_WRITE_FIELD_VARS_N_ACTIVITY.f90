...
!
!***********************************************************************************************************************************
  SUBROUTINE MR_WRITE_ACTIVITY( DSET_ACTIVITY_ID , NEM , NI , NJ , ACTIVITY , ERROR , ERRMSG )
    ...
    ELSE
      ...
      ELSE
        ...
        IF( PRESENT( ACTIVITY ) ) THEN
          CALL MR_WRITE_ACTIVITY( DSET_UV_ID , NEM , NI , NJ , ACTIVITY , ERROR , ERRMSG )
          IF( ERROR < 0 ) THEN
  ...
  & ACTIVITY , ERROR , ERRMSG )
    ...
    ELSE
      ...
      ELSE
        ...
        IF( PRESENT( ACTIVITY ) ) THEN
          CALL MR_WRITE_ACTIVITY( DSET_SS_ID , NEM , NI , NJ , ACTIVITY , ERROR , ERRMSG )
          IF( ERROR < 0 ) THEN
