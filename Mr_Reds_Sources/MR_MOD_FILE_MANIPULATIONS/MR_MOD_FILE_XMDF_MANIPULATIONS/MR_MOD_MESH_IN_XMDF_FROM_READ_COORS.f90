...
!***********************************************************************************************************************************
  SUBROUTINE MR_READ_XY( MESH_IN_XMDF_ID , NND , NI , NJ , XYUV , XYUU , XYVV , XYOO , ERROR , ERRMSG )
    ...
    REAL   (XYRD_KIND) , INTENT(OUT) , DIMENSION(1:NI,1:NJ,1:2) :: XYUV
    REAL   (XYRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,1:NJ,1:2) :: XYUU
    REAL   (XYRD_KIND) , INTENT(OUT) , DIMENSION(1:NI,0:NJ,1:2) :: XYVV
    REAL   (XYRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ,1:2) :: XYOO
