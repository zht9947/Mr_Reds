...
!***********************************************************************************************************************************
  SUBROUTINE MR_READ_NDID( MESH_IN_XMDF_ID , NEM , NI , NJ , EMIDW , NDIDW , NDIDU , NDIDV , NDIDO , ERROR , ERRMSG )
    ...
    INTEGER(EMID_KIND) , INTENT(IN ) , DIMENSION(1:NI,1:NJ) :: EMIDW

    INTEGER(NDID_KIND) , INTENT(OUT) , DIMENSION(1:NI,1:NJ) :: NDIDW
    INTEGER(NDID_KIND) , INTENT(OUT) , DIMENSION(0:NI,1:NJ) :: NDIDU
    INTEGER(NDID_KIND) , INTENT(OUT) , DIMENSION(1:NI,0:NJ) :: NDIDV
    INTEGER(NDID_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ) :: NDIDO
