...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_ZS_U( NI , NJ , ZS , ZSU )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI,1:NJ) :: ZS
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,1:NJ) :: ZSU
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_UV_O_U( NI , NJ , U , UO )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(0:NI,1:NJ    ) :: U
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ    ) :: UO
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_SS_O_U( NI , NJ , SU , SUO )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ) :: SUO
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_ZS_O_U( NI , NJ , ZSU , ZSUO )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ) :: ZSUO
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_ZS_V( NI , NJ , ZS , ZSV )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI,1:NJ) :: ZS
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(1:NI,0:NJ) :: ZSV
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_UV_O_V( NI , NJ , V , VO )
    ...
    REAL   (FDRD_KIND) , INTENT(IN ) , DIMENSION(1:NI,0:NJ    ) :: V
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ    ) :: VO
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_SS_O_V( NI , NJ , SV , SVO )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ) :: SVO
...
!***********************************************************************************************************************************
  SUBROUTINE MR_INTERP_XY_ZS_O_V( NI , NJ , ZSV , ZSVO )
    ...
    REAL   (FDRD_KIND) , INTENT(OUT) , DIMENSION(0:NI,0:NJ) :: ZSVO
